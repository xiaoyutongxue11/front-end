...
function getProvinces() {
    ...
    for (var i = 0; i < data.length; i++) {
        if (data[i].item_code.substring(2, 6) === "0000") {
...
function getCities(provinceCode) {
    var cities = [];
    for (var i = 0; i < data.length; i++) {
        if (data[i].item_code.substring(0, 2) === provinceCode.substring(0, 2) &&
            data[i].item_code.substring(2, 4) !== "00" &&
            data[i].item_code.substring(4, 6) === "00") {
            cities.push(data[i]);
        }
    }
    return cities;
...
function getCounties(cityCode) {
    var counties = [];
    for (var i = 0; i < data.length; i++) {
        if (data[i].item_code.substring(0, 4) === cityCode.substring(0, 4) &&
            data[i].item_code.substring(4, 6) !== "00") {
...
function loadProvinces() {
    ...
    for (var i = 0; i < provinces.length; i++) {
        //provinceSelect.innerHTML+='<option value="'+provinces[i].item_code+'">'+provinces[i].item_name+'</option>';
        var option = document.createElement("option");
        option.value = provinces[i].item_code;
        option.text = provinces[i].item_name;
...
function loadCities(provinceCode) {
    ...
    for (var i = 0; i < cities.length; i++) {
        //citySelect.innerHTML+= '<option value="' + cities[i].item_code + '">' + cities[i].item_name + '</option>';
        var option = document.createElement("option");
        option.value = cities[i].item_code;
        option.text = cities[i].item_name;
...
function loadCounties(cityCode) {
    ...
    countySelect.innerHTML = '<option>请选择县</option>';
    for (var i = 0; i < counties.length; i++) {
        //countySelect.innerHTML+= '<option value="' + counties[i].item_code + '">' + counties[i].item_name + '</option>';
        var option = document.createElement("option");
        option.value = counties[i].item_code;
        option.text = counties[i].item_name;
